    ...
    return [
      {
        ...
        value1: [
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][0]["basicRateBand"]) *
                (parseInt(list["rateBands"][0]["basicRateBandPercentage"]) /
                  100)
            ).toFixed(2),
          },
          {
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][0]["additionalRateBand"]) *
                (parseInt(
                  list["rateBands"][0]["additionalRateBandPercentage"]
                ) /
                  100)
            ).toFixed(2),
          },
      ...
      },
      {
        ...
        value1: [
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][1]["basicRateBand"]) *
                (parseInt(list["rateBands"][1]["basicRateBandPercentage"]) /
                  100)
            ).toFixed(2),
          },
          {
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][1]["additionalRateBand"]) *
                (parseInt(
                  list["rateBands"][1]["additionalRateBandPercentage"]
                ) /
                  100)
            ).toFixed(2),
          },
      ...
      },
      {
        ...
        value1: [
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][2]["basicRateBand"]) *
                (parseInt(list["rateBands"][2]["basicRateBandPercentage"]) /
                  100)
            ).toFixed,
          },
          {
          ...
          },
          {
            ...
            value2: parseFloat(
              parseFloat(list["rateBands"][2]["additionalRateBand"]) *
                (parseInt(
                  list["rateBands"][2]["additionalRateBandPercentage"]
                ) /
                  100)
            ).toFixed(2),
          },
    ...
    return [
      {
        ...
        value2: "",
        value3: parseFloat(
          list["rentalIncomeTaxAdjustment"]["totalIncomeTaxDue"]
        ).toFixed(2),
      },
      {
      ...
      },
      {
        ...
        value3: parseFloat(
          list["rentalIncomeTaxAdjustment"][
            "incomeTaxDueAfterReliefsAndTaxReductions"
          ]
        ).toFixed(2),
      },
    ];
    ...
    return [
      {
        ...
        value1: parseFloat(
          list["taxPaidAtSource"]["totalTaxPaidAtSource"]
        ).toFixed(2),
        value2: "",
      },
      {
        ...
        value1: "",
        value2: parseFloat(
          list["taxPaidAtSource"]["totalTaxDeduction"]
        ).toFixed(2),
      },
      {
        ...
        value1: "",
        value2: parseFloat(
          list["taxPaidAtSource"]["incomeTaxDueAfterDeductions"]
        ).toFixed(2),
      },
    ];
  };
    ...
    return [
      {
        ...
        value2: parseFloat(
          parseFloat(
            ...
            (parseInt(
              list["nonUKResidentialPropertyCapitalGain"]["percentage"]
            ) /
              100)
        ).toFixed(2),
      },
    ...
    return [
      {
        ...
        value1: parseFloat(
          list["ukResidentialPropertyCapitalGain"]["income"]
        ).toFixed(2),
        value2: "",
      },
      {
      ...
      },
      {
        ...
        value1: "",
        value2: parseFloat(
          list["ukResidentialPropertyCapitalGain"]["totalIncomeTaxDue"]
        ).toFixed(2),
      },
    ];
  };
                ...
                <div style={{ margin: "1rem", marginTop: "2rem" }}>
                  ...
                  <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                      ...
                      <TableBody>
                        {getUkResidentialPropertyCapitalGain()?.map(
                          (row, i) => {
                            if (i === +1) {
                              return (
                                <TableRow
